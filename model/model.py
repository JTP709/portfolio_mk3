projects = [
	{
		...
		'description': 'A single page applicatin developed using React.js for a professional Pet Sitting Service. In addition to React.js, this app uses React-Router for declarative routing and React Bootstrap for site responsivness. This site was developed in collaboration with Steven Dilbrert.',
